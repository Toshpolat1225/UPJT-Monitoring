...
const dict = {
  ...
  periodLimit: { uz: "Davr limiti", ru: "Davr limiti" },
  periodFact: { uz: "Davr fakti", ru: "Davr fakti" },
  periodDeviation: { uz: "Davr og'ishi", ru: "Davr og'ishi" },
  periodPercent: { uz: "Davr foizi", ru: "Davr foizi" },
